...
Figure 6.3.
```{r fig.6.3, fig.cap="Last-chance exams and Texas sheepskin",message=FALSE,warning=FALSE}
...
Figure 6.4.
```{r fig.6.4, fig.cap="The effect of last-chance exam scores on earnings",message=FALSE,warning=FALSE}
