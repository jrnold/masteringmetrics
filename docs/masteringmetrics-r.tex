...
Create a table similar to J. D. Angrist and Pischke (2014) Table 1.3.
...
Figure 5.3 of J. D. Angrist and Pischke (2014).
...
\StringTok{    }\KeywordTok{unnest}\NormalTok{(coefs) }\OperatorTok{%>%}
\StringTok{    }\KeywordTok{filter}\NormalTok{(term }\OperatorTok{%in%}\StringTok{ }\KeywordTok{c}\NormalTok{(}\StringTok{"legal"}\NormalTok{, }\StringTok{"beertaxa"}\NormalTok{)) }\OperatorTok{%>%}
\StringTok{    }\KeywordTok{mutate}\NormalTok{(}\DataTypeTok{response =}\NormalTok{ i) }\OperatorTok{%>%}
