#' Quarter of Birth and Return to Schooling Data
#'
#' Data from Angrist and Krueger (1991), which estimate returns to schooling
#' using quarters of birth as an instrument for years of schooling.
#' These data are used in Tables 6.4. and 6.5 and Figures 6.1 and 6.2 of *Mastering 'Metrics*.
#'
#' @format A data frame.
