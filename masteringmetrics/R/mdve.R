...
#'
#' Data from the Minneapolis Domestic Violence Experiment (MDVE)
#' used in Table 3.3 of *Mastering 'Metrics*.
#'
#' @format A data frame.
#'
...
#'
#' -   Sherman, L.A., Berk, R.A. (1984)
#'     \dQuote{The Specific Deterrent Effects of Arrest for Domestic Assault}
