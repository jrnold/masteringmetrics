#' Sheepskin Effects Data
#'
#' Data used in Clark and Martorell (2014) analyze the "sheepskin effects"
#' of the returns to schooling of a high school diploma with a fuzzy RD design.
#' This data was used in Figures 6.3 and 6.4 of *Mastering 'Metrics*.
#'
#' @format A data frame.
